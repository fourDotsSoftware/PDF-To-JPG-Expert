...
;copy translations end
  ...
  !define MUI_FILE "PDFToJPGExpert"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "PDF To JPG Expert"
  !define PRODUCT_SHORTCUT "PDF To JPG Expert"
  !define PRODUCT_VERSION "2.10"
  
  !define MUI_ICON "pdftojpg_48x48.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "PDF To JPG Expert"
  OutFile "PDFToJPGExpertSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\PDF To JPG Expert" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\PDF To JPG Expert - User's Manual.url.lnk" "$INSTDIR\PDF To JPG Expert - User's Manual.url" "" "$INSTDIR\PDF To JPG Expert - User's Manual.url" 0
...
!endif
  ...
  ;!insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\PDFToJPGExpertShellExtx64.dll $SYSDIR\PDFToJPGExpertShellExt.dll $SYSDIR
  SetRegView 64
...
;   ExecWait '"$INSTDIR\vcredist_x86.exe" /q'
  ;!insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\PDFToJPGExpertShellExt_vs2008_w7_x86.dll $SYSDIR\PDFToJPGExpertShellExt.dll $SYSDIR
...
;   inetc::get /SILENT "http://www.4dots-software.com/installmonetizer/PDFToJPGExpert.php" "$PLUGINSDIR\Installmanager.exe" /end
...
;  inetc::get /SILENT "http://www.4dots-software.com/installmonetizer/PDFToJPGExpert.php" "$PLUGINSDIR\Installmanager.exe" /end
 ...
 ; Delete $SYSDIR\PDFToJPGExpertShellExt.dll 
  File "CryptoObfuscator_Output\${MUI_FILE}.exe"
 ; File "readme.txt"
  File "PDF To JPG Expert - User's Manual.url";
  File "license_agreement.rtf"
  ;File "vcredist_x64.exe"
  ;File "vcredist_x86.exe"
  File "PdfToImage.dll"
  File "PdfPageTools.dll"
  File "itextsharp.dll"
  File "gsdll32.dll"
  File "PdfSharp.dll"  
  ...
  ;File "pdf-to-jpg-expert-150.png"
...
;  Pop $0
  ...
  ;nsExec::Exec "$INSTDIR\net_updater32.exe --install win_pdftojpgexpert.4dotssoftware.com"
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\PDF To JPG Expert" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\PDF To JPG Expert" "InstallationDirectory" $INSTDIR
...
!endif
  ...
  ;!insertmacro UnInstallLib REGDLL NOTSHARED NOREBOOT_NOTPROTECTED $SYSDIR\PDFToJPGExpertShellExt.dll
  SetRegView 64
   SetShellVarContext all
; 64bit things here
...
${EndIf}  
 ...
 ;nsExec::Exec "$INSTDIR\net_updater32.exe --uninstall win_pdftojpgexpert.4dotssoftware.com" 
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\PDF To JPG Expert"
  DeleteRegKey HKCU "Software\4dots Software\PDF To JPG Expert"
...
Function .onInstSuccess
 ...
 ExecShell "" "http://www.4dots-software.com/pdf-to-jpg-expert/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
FunctionEnd
...
Function .onInit
  ...
  ;StrCpy $RevenyouProduct "PDF+To+JPG+Expert";         
...
Function OpenWebpageFunction
  ;ExecShell "" "http://www.4dots-software.com/pdf-utilities/pdf-to-jpg-expert/how-to-use.php?afterinstall=true"
